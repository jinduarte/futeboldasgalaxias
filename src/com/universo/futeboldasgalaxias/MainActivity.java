...
public class MainActivity extends ActionBarActivity implements
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.action_cad_grupos) {
			return true;
		}
		if (id == R.id.action_cad_jogadores) {
			return true;
		}
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (itemClicado) {
            case R.id.action_cad_grupos:
                //Log.i("TAG", "BOTAO CLICADO CASE");
                mudarTela = new Intent(this, GruposCadastroActivity.class);
                startActivity(mudarTela);
                break;
            case R.id.action_cad_jogadores:
                //Log.i("TAG", "BOTAO CLICADO CASE");
                ...
                //startActivity(mudarTela);
                mudarTela = new Intent(this, JogadoresCadastroActivity.class);
                startActivity(mudarTela);
                break;
            default:
                break;
